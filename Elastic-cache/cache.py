...
redis_client = redis.Redis(
    host='cache-brv7qp.serverless.use1.cache.amazonaws.com',
    port=6379,
    ssl=True,
...
db_write_config = {
    'host': 'database-1.cq1w8egokznj.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'admin123',
    'database': 'dev'
}
...
db_read_config = {
    'host': 'replica.cq1w8egokznj.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'admin123',
    'database': 'dev'
}
